        ...
        <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel" style="width: 250px;">
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav nav-pills flex-column justify-content-end flex-grow-1">
                    ...
                    <li class="nav-item">
                        <a class="nav-link link-dark" href="manajemen_alat.php"><i class="bi bi-tools"></i> Manajemen Alat </a>
                    </li> 
                    <li class="nav-item">
                        <a class="nav-link link-dark" href="manajemen_pengguna.php"><i class="bi bi-person-fill"></i> Manajemen Pengguna </a>
                    </li>    
                    <li class="nav-item">
                        <a class="nav-link link-dark" href="peminjaman_pengembalian.php"><i class="bi bi-arrow-repeat"></i> Proses Peminjaman dan Pengembalian </a>
                    </li>    
                    <li class="nav-item">
